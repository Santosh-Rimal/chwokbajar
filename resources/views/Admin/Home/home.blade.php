            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4"
                        href="{{ route('admin.homes.create') }}">Add Home</a>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <img class="w-16 h-16 rounded object-cover"
                                            src="{{ asset('admin/assets/images/home/' . $home->image) }}"
                                            alt="Image">
                                    </td>
                                    <td
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a class="text-blue-600 hover:text-blue-900"
                                            href="{{ route('admin.homes.edit', $home->id) }}">Edit</a>

                                        <!-- Delete Form -->
                                        <form class="inline-block"
                                            action="{{ route('admin.homes.destroy', $home->id) }}" method="POST"
                                            onsubmit="return confirm('Are you sure you want to delete this home entry?');">
                                            @csrf
                                            @method('DELETE')
                                            <button
